...
function buildUI(thisObj) {
  ...
  var nthGrp;
  var logicGrp;
  var logicList = ['set', 'and (intersect)', 'or (add)', 'xor (difference)', 'select in current', '-', '-', '-'];
  var nthText;
  var offsetText;
  var suffixTxt;
  var offsetGrp;
  ...
  if (pal !== null) {
    ...
    selectionModePanel.size = {width: 180, height: undefined};
    nthGrp = selectionModePanel.add('group');
    nthGrp.orientation = 'row';
    nthGrp.minimumSize = {width: 120, height: undefined};
    ...
    nthText.minimumSize = {width: 30, height: undefined};
    suffixTxt.minimumSize = {width: 30, height: undefined};
    offsetGrp = selectionModePanel.add('group');
    offsetGrp.minimumSize = {width: 120, height: undefined};
    offsetGrp.add('staticText', undefined, 'starting from');
    offsetText = offsetGrp.add('editText', undefined, '1');
    offsetText.minimumSize = {width: 30, height: undefined};
